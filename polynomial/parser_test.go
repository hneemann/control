...
func Test_addPrefix(t *testing.T) {
	tests := []struct {
		...
		{name: "nano", arg: 1e-9, want: "1n"},
		{name: "nano2", arg: 100e-9, want: "100n"},
		{name: "mu", arg: 1e-6, want: "1μ"},
		{name: "mu1", arg: 100e-6, want: "100μ"},
		{name: "milli", arg: 2e-3, want: "2m"},
		{name: "kilo", arg: 2e3, want: "2k"},
		{name: "kilo1", arg: 1e3, want: "1k"},
		...
		{name: "l2", arg: 1e19, want: "10E"},
		{name: "l3", arg: 1e20, want: "100E"},
